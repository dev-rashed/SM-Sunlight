...
@section('content')
<h2 class="text-center">Welcome to <br>
  <h1 class="text-center" style="color: #0E56A1; font-weight: bold; font-size: 30px;">{{app_setting('appname')}}</h1>
</h2>
...
<marquee behavior="scroll" direction="left" scrollamount="5"
  ...
  ( সানলাইট ব্যাটারি হাউস )
</marquee>

<marquee behavior="scroll" direction="Right" scrollamount="5"
  style="color:#0E56A1; font-weight: bold; font-size:22px;   padding: 1px; border-radius: 5px; ">Mayer Doa Battery House
  & IPS ( মায়ের দোয়া ব্যাটারী হাউস এন্ড আই.পি.এস )
</marquee>

<marquee behavior="scroll" direction="left" scrollamount="5"
  style="color:#0E56A1; font-weight: bold; font-size:22px;   padding: 1px; border-radius: 5px; "> Sunlight Battery & IPS
  ( সানলাইট ব্যাটারী এন্ড আই.পি.এস )
</marquee>

<marquee behavior="scroll" direction="Right" scrollamount="5"
  style="color:#0E56A1; font-weight: bold; font-size:22px;   padding: 1px; border-radius: 5px; ">Rangdhanu Battery House
  ( রংধনু ব্যাটারী হাউস )
</marquee>
