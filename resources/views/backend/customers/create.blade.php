      ...
      <div class="card mb-3 p-3">
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="date" id="myDate" value="{{ old('date') }}" class="form-control datepicker"
              required />
          </div>
          <div class="col-md-6">
...
<script>
  ...
  let day = String(currentDate.getDate()).padStart(2, '0');  // Ensures two digits
  let month = String(currentDate.getMonth() + 1).padStart(2, '0');  // Month is 0-indexed
