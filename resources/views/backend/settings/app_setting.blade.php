      ...
      <div class="card-body">
        <form action="{{ route('store_settings') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3 col-12">
            ...
            <input type="text" id="appname" name="appname" class="form-control" value="{{app_setting('appname')}}"
              placeholder="Solar Project">
          </div>
          <div class="d-flex align-items-start align-items-sm-center gap-4 mb-3">
            <img src="{{ app_setting('logo') ? app_setting('logo') : asset('assets/img/avatars/1.png') }}"
            ...
            <div class="button-wrapper">
              <label for="logo" class="btn btn-primary me-2 mb-4" tabindex="0">
                ...
                <input type="file" id="logo" name="logo" class="logo" hidden="" accept="image/png, image/jpeg">
              </label>
          ...
          <div class="mb-3 col-12">
            ...
            <input type="text" id="adminemail" name="adminemail" class="form-control"
              value="{{app_setting('adminemail')}}" placeholder="admin@gmail.com">
          </div>
    ...
    <div class="card mb-4">
      <div class="card-body">
        <form action="{{ route('store_settings') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="mb-3 col-12">
            <label class="form-label" for="institute_sms">Institute Visit Report SMS</label>
            <input type="hidden" name="type[]" value="institute_sms">
            <textarea name="institute_sms" rows="8" class="form-control">{{app_setting('institute_sms')}}</textarea>
          ...
          <div class="card mb-4">
            <div class="card-body">
              <form action="{{ route('csv_import') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="mb-3 col-12">
                    <label class="form-label" for="csv">Upload CSV</label>
