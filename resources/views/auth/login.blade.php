  ...
  <div class="authentication-inner row m-0">
    ...
    <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
      <div class="w-px-400 mx-auto">
        ...
        <!-- /Logo -->
        <h4 class="mb-2">Welcome to {{app_setting('appname')}}! 👋</h4>
        ...
        <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
          ...
          <div class="mb-3 form-password-toggle">
            ...
            <div class="input-group input-group-merge">
              ...
              <span class="input-group-text cursor-pointer view-password"><i class="fa-regular fa-eye d-none"></i><i class="fa-regular fa-eye-slash"></i></span>
              @error('password')
              <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
              </span>
...
<script>
    document.querySelector(".view-password").addEventListener("click", function() {
        var pass = document.querySelector("#login-password");
